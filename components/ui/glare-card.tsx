...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(200,255,255,0.1) 12%,rgba(255,255,255,0.15) 20%,rgba(255,255,255,0.25) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
